...
class WinningScreen:
    ...
    def __init__(self, screen, victory, score):
        ...
        self.buttons.new_special_button(
            ...
            self.set_response, ("restart", ) if not victory else ("next level", )
        )
        self.buttons.new_special_button(
        ...
        self.texts = [self.font.render("next level" if self.victory else "restart", True, (0, 0, 0)), self.font.render("quit", True, (0, 0, 0))]
    ...
    def update(self):
        ...
        label = self.font.render("You Won !" if self.victory else "You Lost !", True, (0, 0, 0))
